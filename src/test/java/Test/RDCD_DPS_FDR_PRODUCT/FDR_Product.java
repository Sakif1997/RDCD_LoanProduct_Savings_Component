...
public class FDR_Product extends BrowserSetup {
	...
	public void ProductSetup() throws InterruptedException{
		...
		SPM.ProductInfoPage();
		test.pass("test by base64", MediaEntityBuilder.createScreenCaptureFromBase64String(methods.captureScreenshot_base64());
        test.pass("Product page appeared", MediaEntityBuilder.createScreenCaptureFromPath("C:/Users/user/eclipse-workspace/RDCD_DPS_FDR_PRODUCT/Screenshot(Extent Report)/screenshot1.png").build());
		//test.pass("Product page appeared");
		Firstpage.FillupFirstProductSetupPage("প্রোডাক্ট অটোমেশন 009-২০২৪", "1000", "100000", "1000");//product Bangla Name, Lowest amount, highest amount, gunitok
